  ...
  return (
    <>
      <Wrapper>
        <Stress>
          <LeftWrapper>
            ...
            <ThemeText style={{ fontSize: '16px', fontFamily: 'Roboto', fontWeight: 'bold' }}>
              {t(
            ...
            <div style={{ marginTop: '32px' }}>
              <NavLink to="/swap">
                <Button
                  ...
                  scale="md"
                >
                  <Text color="white" bold fontFamily="Roboto" fontWeight={100} fontSize="16px" mr="4px">
                    {t('GET IT NOW')}
                  </Text>
                </Button>
              </NavLink>
      ...
      <Inner>
        <CardLeftWrapper>
          <StyledStaBtnUnTxt>
            <ThemeText style={{ fontSize: '12px', fontFamily: 'Roboto' }}>
              {t(' SWITCH VIEWS OR GO BACK TO ')}
            </ThemeText>
            <LoremText style={{ fontSize: '12px', fontFamily: 'Roboto' }}>{t('DEFAULT')}</LoremText>
          </StyledStaBtnUnTxt>
        </CardLeftWrapper>
      </Inner>
    </>
