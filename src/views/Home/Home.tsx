...
import { Text, Grid } from 'dbx-swap-uikit'
...
const RightCol = styled.div`
  background-color: ${({ theme }) => (theme.isDark ? '#1e2c37' : 'white')};
...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    setColaUSDPrice(Number(getFullDisplayBalance(colaPrice, 10, 25)))
        ...
        <StyledPage>
          ...
          <Row>
            <LeftCol>
              <LeftGridLayout>
                <div>
                  <StyledText> {t('Your COLA balance')} </StyledText>
                ...
                <div>
                  <StyledText color="black"> {t('COLA price')} </StyledText>
                  <CardValue decimals={25} value={colaUSDPrice} color="black" />
                </div>

                <div>
                  <StyledText color="black"> {t('COLA Market Cap')} </StyledText>
                  <CardValue decimals={0} value={colaMarketCapUSDBalance} color="black" />
                </div>

                <div>
                  <StyledText color="black"> {t('COLA in Circulation')} </StyledText>
            ...
            <RightCol>
              ...
              <StyledBorder />
              <StyledNFTitem>
                <StyledText1 color="white"> {t('COLA Locked by NFT')} </StyledText1>
                <StyledCardValue1> {t('0.000')} </StyledCardValue1>
              </StyledNFTitem>
            </RightCol>
          </Row>
