...
import { Checkbox, Text, Button, AutoRenewIcon, ArrowBackIcon } from 'dbx-swap-uikit'
...
const StyledCheckBox = styled(Checkbox)`
  background-color: ${({ theme }) => (theme.isDark ? '#1e2c37' : '#F0F2FA')};
...
const StyledModal = styled.div`
  background-color: ${({ theme }) => (theme.isDark ? '#1e2c37' : '#fff')};
  border-radius: 20px;
  border: none;
  margin: 0 auto;
