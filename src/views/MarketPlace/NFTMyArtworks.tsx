...
import { Button, ArrowBackIcon, SearchIcon, ButtonMenu } from 'dbx-swap-uikit'
...
const StyledDiv = styled.div`
  width: 100%;
  background-color: ${({ theme }) => (theme.isDark ? '#1e2c37' : '#f8f8f8')};
              ...
              <ButtonGroup activeIndex={tabId} onItemClick={handleClickTab}>
                {searchButtonArray.map((btn) => (
                  <CustomButton
                    ...
                    backgroundColor={btn.id === tabId ? '#1FC7D4' : `#1FC7D466`}
                  >
                    {btn.btnName}
                  </CustomButton>
                ))}
