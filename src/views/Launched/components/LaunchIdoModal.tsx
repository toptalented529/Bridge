  ...
  return (
    <StyledModal minWidth="400px">
      ...
      <NowLive>
        ...
        <LoremText>{t('Zilionixx')}</LoremText>
        {t('!')}
      </NowLive>
      <Text style={{ color: 'white', fontSize: '30px', fontFamily: 'Roboto', marginBottom: '8px' }}>
        {t(
          'Zilionixx is a decentralized trading platform that uses the automatic market maker(AMM) model. At the same time Zilionixx is an AMM+NFT exchange on the Binance Smart Chain. Various data indicate the rapid growth of Zilionixx in the DEFI ecosystem.',
        )}
      </Text>
      <Button
        scale="sm"
