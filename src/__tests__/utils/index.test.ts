...
describe('utils', () => {
  describe('#getZnxScanLink', () => {
    it('correct for tx', () => {
      expect(getZnxScanLink('abc', 'transaction', ChainId.MAINNET)).toEqual('https://znxscan.com/tx/abc')
    })
    it('correct for token', () => {
      expect(getZnxScanLink('abc', 'token', ChainId.MAINNET)).toEqual('https://znxscan.com/token/abc')
    })
    it('correct for address', () => {
      expect(getZnxScanLink('abc', 'address', ChainId.MAINNET)).toEqual('https://znxscan.com/address/abc')
    })
    it('enum', () => {
      expect(getZnxScanLink('abc', 'address', ChainId.TESTNET)).toEqual('https://testnet.znxscan.com/address/abc')
    })
  })
