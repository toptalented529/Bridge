...
describe('formatBnb', () => {
  it.each([
    ...
    [689.889, '689.889'],
    [10.8829, '10.883'],
  ])('format %i DBX correctly with 3 decimals', (value, expected) => {
    expect(formatBnb(value)).toEqual(expected)
  })

  it('returns 0 if DBX is undefined', () => {
...
describe('getPayout', () => {
  ...
  it.each([
    [bet1Bull, 0.1339, 727.5],
    [bet1Bear, 0.1339, 1455],
    [bet2Bull, 0.1339, 1201.248],
    [bet2Bear, 0.1339, 1501.56],
